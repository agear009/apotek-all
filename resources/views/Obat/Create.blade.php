          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Pastikan data obat dan gambar obat tersedia karena isian harus lengkap dan tidak boleh ada field atau inputan yang kosong</h6>
              </div>
              <div class="ms-md-auto py-2 py-md-0">


                <a href="{{ route('obat.create') }}" class="btn btn-primary btn-round">Tambah Obat</a>
              </div>
            </div>
            <div class="row">
                ...
                <div class="card card-round">
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">Masukan Data Obat</div>
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="id_category" name="category" aria-describedby="category" required >
                                    <option name="category" value="{{ old('id') }}">{{ old('name') }}</option>
                          ...
                          <tr>
                            ...
                            <input type="hidden" class="form-control" id="name" name="id_toko" aria-describedby="Cover" value="{{ auth()->user()->id_toko}}" required readonly>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="dosis" value="{{ old('dosis') }}" aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="aturan_pakai">{{ old('aturan_pakai') }}</textarea>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="komposisi">{{ old('komposisi') }}</textarea>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="jangan_digunakan_oleh">{{ old('jangan_digunakan_oleh') }}</textarea>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="efek_samping">{{ old('efek_samping') }}</textarea>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="promo" name="bentuk" aria-describedby="category" required >
                                    <option name="bentuk" value="{{ old('bentuk') }}">{{ old('bentuk') }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="promo" name="resep" aria-describedby="category" required >
                                    <option name="resep" value="{{ old('resep') }}">{{ old('resep') }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                <label for="exampleInputname1" class="form-label">Warna Obat</label>
                                <select class="form-control" id="promo" name="jenis_obat" aria-describedby="category" required >
                                    <option name="jenis_obat" value="{{ old('jenis_obat') }}">{{ old('jenis_obat') }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="promo" name="kemasan" aria-describedby="category" required >
                                    <option name="kemasan" value="{{ old('kemasan') }}">{{ old('kemasan') }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control format-rupiah" id="harga_jual"
                                       value="{{ old('price', '') }}" required>
                                <input type="hidden" name="price" id="harga_jual_db" value="{{ old('price', '') }}">
                            </th>
                        </tr>
                        <tr>
                            <th scope="row" colspan="6">
                                <label for="harga_beli" class="form-label">Harga Beli</label>
                                <input type="text" class="form-control format-rupiah" id="harga_beli"
                                       value="{{ old('harga_beli', '') }}" required>
                                <input type="hidden" name="harga_beli" id="harga_beli_db" value="{{ old('harga_beli', '') }}">
                            </th>
                        </tr>
                        <tr>
                            <th scope="row" colspan="6">
                                <label for="harga_coret" class="form-label">Harga Coret</label>
                                <input type="text" class="form-control format-rupiah" id="harga_coret"
                                       value="{{ old('harga_coret', '') }}" required>
                                <input type="hidden" name="harga_coret" id="harga_coret_db" value="{{ old('harga_coret', '') }}">
                            </th>
                        </tr>
                        ...
                        document.querySelectorAll(".format-rupiah").forEach((input) => {
                            input.addEventListener("keyup", function () {
                                ...
                                let formattedValue = new Intl.NumberFormat("id-ID").format(value); // Format ke Rupiah
                                this.value = formattedValue; // Set tampilan dengan format

                                // Simpan nilai asli (tanpa titik) ke input hidden
                                if (this.id === "harga_jual") {
                                    document.getElementById("harga_jual_db").value = value;
                                } else if (this.id === "harga_beli") {
                                    document.getElementById("harga_beli_db").value = value;
                                } else if (this.id === "harga_coret") {
                                    document.getElementById("harga_coret_db").value = value;
                                }
                            });

                            // Saat halaman dimuat, ubah nilai lama menjadi format rupiah
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="produksi" value="{{ old('produksi') }}" aria-describedby=" author name" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="produsen" value="{{ old('produsen') }}" aria-describedby=" author name" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="stock" value="{{ old('stock') }}" aria-describedby="source" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="promo" name="promo" aria-describedby="category" required >
                                    <option name="promo" value="{{ old('promo') }}">{{ old('promo') }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="merek" aria-describedby="source" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="promo" name="best_seller" aria-describedby="category" required >
                                    <option name="best_seller" value="{{ old('best_seller') }}">{{ old('best_seller') }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="jumlah_penjualan" aria-describedby="source" value="0" required>

                            </th>
                          </tr>
                          <tr>
                            <th scope="row" colspan="6">
                                <label for="exampleInputname1" class="form-label">Jumlah maksimal Yang Bisa Dibeli OLeh Konsumen</label>
                                <input type="text" class="form-control" id="producer" name="jumlah_maksimal_beli" value="{{ old('jumlah_maksimal_beli') }}" aria-describedby="source" value="0" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="berat" value="{{ old('berat') }}" aria-describedby="source"  required>
