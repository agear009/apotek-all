                  ...
                  <div class="card-body p-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="title" value="{{ old('title') }}"  aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="author" value="{{ old('author') }}"  aria-describedby=" author name" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" value="{{ old('source') }}"  name="source" aria-describedby="source" required>
                    ...
                    <script>
                        ...
                        window.onload = function() {
                            ...
                            if (post.image) {
                                imagePreview.innerHTML = `<img src="storage/posts/${post.image}" width="20%"><br>`;
                            }
                        }
                        ...
                        function validateForm() {
                            const fileInput = document.getElementById('imageUpload');
                            if (!fileInput.files[0] && !post.image) {
