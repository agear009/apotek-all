                  ...
                  <div class="card-body p-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="pemilik" value="{{ old('pemilik') }}"  aria-describedby=" author name" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="harga" value="{{ old('harga') }}"  aria-describedby="source" required>
                    ...
                    <script>
                        ...
                        window.onload = function() {
                            ...
                            if (asetkantor.image) {
                                imagePreview.innerHTML = `<img src="storage/aset_kantors/${asetkantor.image}" width="20%"><br>`;
                            }
                        }
                        ...
                        function validateForm() {
                            const fileInput = document.getElementById('imageUpload');
                            if (!fileInput.files[0] && !asetkantor.image) {
