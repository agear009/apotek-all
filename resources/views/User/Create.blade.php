                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="password" value="{{ old('password') }}" aria-describedby="password" required>
                              ...
                              <tr>
                                ...
                                <label for="exampleInputname1" class="form-label">Level</label>
                                    ...
                                    <option class="form-control" id="level_user" name="level" value="User">User</option>
                                        ...
                                        <option class="form-control" id="level_user" name="level" value="Pemilik_Apotek">Pemilik Apotek</option>
                                    </select>
                                </th>
                              </tr>
