                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="date" class="form-control" id="name" name="waktu_order" aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="datetime-local" class="form-control" id="name" name="waktu_pengiriman" aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="datetime-local" class="form-control" id="name" name="perkiraan_samapai" aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nama_pengirim" aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="number" class="form-control" id="name" name="jumlah" aria-describedby="name Category" required>
