                      ...
                      <form action="{{ route('order.update', $order->id) }}" method="POST"  enctype="multipart/form-data" >
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <th scope="row" colspan="6">
                                ...
                                <input type="date" class="form-control" id="name" name="waktu_order" aria-describedby="name Category" value="{{ $order->waktu_order }}" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="datetime-local" class="form-control" id="name" name="waktu_pengiriman" aria-describedby="name Category" value="{{ $order->waktu_pengiriman }}" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="datetime-local" class="form-control" id="name" name="perkiraan_samapai" aria-describedby="name Category" value="{{ $order->perkiraan_samapai }}" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nama_pengirim" aria-describedby="name Category"value="{{ $order->nama_pengirim }}" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="number" class="form-control" id="name" name="jumlah" aria-describedby="name Category" value="{{ $order->jumlah }}" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="id_category" name="status" aria-describedby="category" required >
                                    ...
                                    <option name="status" value="{{ $order->status }}">{{ $order-> }}</option>
