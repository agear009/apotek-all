                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="jumlah" value="{{ old('jumlah') }}"  aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="keterangan"> {{ old('keterangan') }}</textarea>
