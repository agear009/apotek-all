<footer id="footer" class="py-5 border-top">
      ...
      <div class="row">
        <div class="col-lg-2 pb-3">
          <div class="footer-menu">
            <h5 class="widget-title pb-2">Tentang </h5>
            <ul class="menu-list list-unstyled">
              <li class="pb-2">
                <a href="#">Artikel</a>
              </li>
              <li class="pb-2">
                <a href="index.html">Kategori Obat</a>
              </li>
              <li class="pb-2">
  ...
  <script src="../../assets/halaman_shop/js/jquery-1.11.0.min.js"></script>
  <script src="../../assets/halaman_shop/js/plugins.js"></script>
  <script src="../../assets/halaman_shop/js/script.js"></script>
