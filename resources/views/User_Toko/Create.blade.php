                        ...
                        <tbody>
                            <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="id_toko" value="auth()->user()->id_toko" aria-describedby="name Category" required>
                            ...
                            <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="email" value="{{ old('email') }}" aria-describedby="name Category" required>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <input type="file" class="form-control" id="name" name="foto"  aria-describedby="Cover" required>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="name" name="nohp" value="{{ old('nohp') }}"  aria-describedby="Cover" required>
                              ...
                              <tr>
                                ...
                                <select class="form-control" id="level_user" name="status" value="{{ old('status') }}"  required>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="name" name="norek" value="{{ old('norek') }}"  aria-describedby="Cover" required>
                                </th>
                              </tr>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="rupiah" name="saldo" value="{{ old('saldo') }}"  aria-describedby="Cover" required>
                                </th>
                              </tr>
                          ...
                          <tr>
                                    <th scope="row" colspan="6">
                                    <input type="hidden" class="form-control" id="level_user" name="spesialis" value="-">
                                  ...
                                  <tr>
                                    ...
                                    <input type="text" class="form-control" id="name" name="praktek" value="{{ old('praktek') }}"  aria-describedby="Cover"  required>
                                    </th>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <input type="text" class="form-control" id="name" name="alamat" value="{{ old('alamat') }}"  aria-describedby="Cover"  required>
                                    </th>
                                  </tr>
                                  ...
                                  <tr>
                                    <th scope="row" colspan="6">
                                    <label for="exampleInputname1" class="form-label">Kelurahan:</label>
