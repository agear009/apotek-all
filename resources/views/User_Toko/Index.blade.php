        ...
        <div class="container">
          <div class="page-inner">
            <div
              ...
              <div>
                <h3 class="fw-bold mb-3">User Toko</h3>
                  ...
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">
                        ...
                        <form class="navbar-left navbar-form nav-search" action="{{ route('user.index') }}" role="search" method="get">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <th scope="col" width="20%"><img src="{{ asset('/storage/public/users/'.$User->foto) }}" width="20%"></th>
