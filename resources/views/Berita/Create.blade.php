                        ...
                        <tbody>
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="id_category" name="id_category" aria-describedby="category" required >
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="source" value="{{ old('source') }}"  aria-describedby="source" required>
