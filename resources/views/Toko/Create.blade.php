          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Silahkan Masukan Toko</h6>
              </div>
                ...
                <div class="card card-round">
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">Masukan Data toko</div>
                  ...
                  <div class="card-body p-0">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" aria-describedby="name Category" value="{{ old('name') }}" required>
                              ...
                              <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <label for="imageUpload">Logo atau foto toko (Max 1MB):</label>
                            ...
                            <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="alamat"  value="{{ old('alamat') }}" aria-describedby="name Category" required>
                            ...
                            <tr>
                              ...
                              <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" aria-describedby="name Category" required>
                              ...
                              <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="nohp" value="{{ old('nohp') }}"  aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="latitude" value="{{ old('latitude') }}"  aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="longitude" value="{{ old('longitude') }}"  aria-describedby="name Category" required>
                          ...
                          <tr>
                            ...
                            <select id="kota" name="kabupaten" class="form-control">
                                ...
                                @endforeach
                                @else
                                <option value="kabupaten">Data tidak ditemukan</option>
                                @endif
                            </select>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                <label for="exampleInputname1" class="form-label">Nama Kurir Apotek</label>
                                <input type="text" class="form-control" id="name" name="kurir" value="{{ old('kurir') }}" aria-describedby="name Category" required>

                                <input type="hidden" class="form-control" id="name" name="bintang" value="0" aria-describedby="name Category" required>

                                <input type="hidden" class="form-control" id="name" name="like" value="0"  aria-describedby="name Category" required>

                                <input type="hidden" class="form-control" id="name" name="follow" value="0" aria-describedby="name Category" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="facebook"  value="{{ old('facebook') }}" aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="tiktok"  value="{{ old('tiktok') }}" aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="instagram"  value="{{ old('instagram') }}" aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="whatsapp" value="{{ old('whatsapp') }}"  aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nama_direktur" aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nama_pic_toko" value="{{ old('nama_pic_toko') }}"  aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nama_apoteker" value="{{ old('nama_apoteker') }}"  aria-describedby="name Category" required>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <label for="imageUpload"> foto PT atau CV (Max 1MB):</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_cv_pt" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <label for="imageUpload">Foto SIUP atau NIB (Max 1MB):</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_siup_nib" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nomor_siup_nib" value="{{ old('nomor_siup_nib') }}"  aria-describedby="name Category" required>
                            </th>
                          </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <label for="imageUpload">Foto KTP (Max 1MB):</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_ktp" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                        </tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="norek" value="{{ old('norek') }}"  aria-describedby="name Category" required>
                            </th>
                          </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <label for="imageUpload">Foto buku tabungan (Max 1MB):</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_buku_tabungan" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                <label for="exampleInputname1" class="form-label">Foto NPWP</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_npwp" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                          </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="nama_npwp"  value="{{ old('nama_npwp') }}" aria-describedby="name Category" required>
                            </th>
                          </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="alamat_npwp"  value="{{ old('alamat_npwp') }}" aria-describedby="name Category" required>
                            </th>
                          </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <label for="imageUpload">Foto SIA (Max 1MB):</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_sia" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="nomor_sia"  value="{{ old('nomor_sia') }}" aria-describedby="source" required>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="date" class="form-control" id="producer" name="tgl_terbit_sia"  value="{{ old('tgl_terbit_sia') }}"  aria-describedby="source" required>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="date" class="form-control" id="producer" name="tgl_kadaluarsa_sia"  value="{{ old('tgl_kadaluarsa_sia') }}" aria-describedby="source" required>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <label for="imageUpload">Foto SIPA (Max 1MB):</label>
                                <input type="file" id="imageUpload" accept="image/*" name="image_sipa" onchange="validateFile()" required>
                                <p id="errorMessage" style="color: red;"></p>
                            </th>
                        </tr>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="nomor_sipa" value="{{ old('nomor_sipa') }}"  aria-describedby="source" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="date" class="form-control" id="producer" name="tgl_terbit_sipa"  value="{{ old('tgl_terbit_sipa') }}"  aria-describedby="source" required>
                        ...
                        <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="date" class="form-control" id="producer" name="tgl_kadaluarsa_sipa"  value="{{ old('tgl_kadaluarsa_sipa') }}" aria-describedby="source" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="ongkir_toko"  value="{{ old('ongkir_toko') }}" aria-describedby="name Category" required>
                            </th>
                          </tr>
                    ...
                    <script>
                        ...
                        window.onload = function() {
                            ...
                            if (toko.image) {
                                imagePreview.innerHTML = `<img src="storage/tokos/${toko.image}" width="20%"><br>`;
                            }
                        }
                        ...
                        function validateForm() {
                            const fileInput = document.getElementById('imageUpload');
                            if (!fileInput.files[0] && !toko.image) {
