          ...
          <div class="page-inner">
            ...
            >
              ...
              <div class="ms-md-auto py-2 py-md-0">
                ...
                <a href="{{ route('toko.create') }}" class="btn btn-primary btn-round">Tambah Alat Kesehatan</a>
                <a href="{{ route('toko.create') }}" class="btn btn-primary btn-round">Tambah Obat</a>
              </div>
            </div>
            <div class="row">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <th scope="col" width="20%"><img src="{{ asset('/storage/public/tokos/'.$toko->image) }}" width="20%"></th>
                            <th scope="col" width="">{{ $order->status }}</th>
