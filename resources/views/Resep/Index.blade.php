                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        ...
                        <h4 class="card-title">{{ $resepcount }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Telah Diproses</p>
                          <h4 class="card-title">{{ $resepcount }}</h4>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">
                        ...
                        <form class="navbar-left navbar-form nav-search" action="{{ route('resep.index') }}" role="search" method="get">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <th scope="col" width="20%">{{ $resep->nomor_resep }}</th>
                            <th scope="col" width="">{{ $resep->id_pasien }}</th>
                            <th scope="col" width="">{!! $resep->diagnosa !!}</th>
                            <th scope="col" width="">{!! $resep->tgl_diberikan !!}</th>
                            ...
                            <td class="text-end">
                                ...
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('resep.destroy', $resep->id) }}" method="POST">
                                    <a href="{{ route('resep.edit', $resep->id) }}" class="btn btn-sm btn"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
