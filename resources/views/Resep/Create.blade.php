          ...
          <div class="page-inner">
            ...
            >
              ...
              <div class="ms-md-auto py-2 py-md-0">
                ...
                <a href="{{ route('order.create') }}" class="btn btn-primary btn-round">Tambah Resep</a>
              </div>
            </div>
            <div class="row">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row" colspan="6">
                                    <label for="exampleInputname1" class="form-label">Nomor Resep</label>
                                    <input type="text" class="form-control" id="name" name="nomor_resep" value="{{ $code }}" aria-describedby="name Category" required>

                                </th>
                              </tr>
                          <tr>
                            <th scope="row" colspan="6">
                                <label for="exampleInputname1" class="form-label">Dokter</label>
                                <select class="form-control" id="id_category" name="id_dokter" aria-describedby="category" required >
                                    @forelse($dokter as $dokter)
                                    <option name="id_dokter" value="{{ auth()->user()->id}}">{{ auth()->user()->name}}</option>
                                    @empty
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="diagnosa">{{ old('diagnosa') }} </textarea>
