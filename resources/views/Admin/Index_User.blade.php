          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Pastikan data sudah lengkap dan benar</h6>
              </div>
              <div class="ms-md-auto py-2 py-md-0">


                <a href="{{ route('home') }}" class="btn btn-primary btn-round">Belanja</a>
              </div>
            </div>
            <div class="row">
                ...
                <div class="card card-round">
                  ...
                  <div class="card-body p-0">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row" colspan="6">
                                        ...
                                        <input type="hidden" class="form-control" id="name" name="level" aria-describedby="name Category" value="{{ $user->level }}" required>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    ...
                                    <label for="imageUpload">Upload Foto (Max 1MB):</label>
                                    <input type="file" id="imageUpload" accept="image/*" name="foto" onchange="validateFile()">
                                  ...
                                  <tr>
                                    ...
                                    <input type="text" class="form-control" id="name" name="latitude" aria-describedby="Cover" value="{{ $user->latitude }}" >
                                    <input type="text" class="form-control" id="name" name="longitude" aria-describedby="Cover" value="{{ $user->longitude }}" >
                                  ...
                                  <tr>
                                    ...
                                    <select id="provinsi" class="form-control" name="provinsi">
                                        ...
                                        @foreach($provinsi as $p)
                                            <option value="{{ $p->nama }}" name="provinsi">{{ $p->nama }}</option>
                                        @endforeach
                                        @else
                                  ...
                                  <tr>
                                    ...
                                    <select id="kota" class="form-control" name="kabupatenkota">
                                        @if(!empty($user->kabupatenkota))
                                        <option >{{ $user->kabupatenkota }}</option>
                                        @else
                                        <option value="">-- Pilih Kota --</option>
                                        @endif
                                        @if(count($kota) > 0)
                                        ...
                                        @foreach($kota as $k)
                                            <option value="{{ $k->nama }}" name="kabupatenkota">{{ $k->nama }}</option>
                                        @endforeach
                                        @else
                                        <option value="" name="kabupatenkota">Data tidak ditemukan</option>
                                        @endif
                                    </select>
                                    </th>
                                  </tr>
                    ...
                    <script>
                        ...
                        const user = {
                            foto: 'example.jpg' // Ganti dengan data dinamis dari backend
                        };

                        window.onload = function() {
                            const imagePreview = document.getElementById('imagePreview');
                            if (user.foto) {
                                imagePreview.innerHTML = `<img src="storage/users/${user.foto}" width="20%"><br>`;
                            }
                        }
                        ...
                        function validateForm() {
                            const fileInput = document.getElementById('imageUpload');
                            if (!fileInput.files[0] && !user.foto) {
