...
<section id="intro" class="position-relative mt-4">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
                ...
                <div class="col mb-4">
                    <div class="product-card position-relative">
                        <div class="card-img">
                            <img src="{{ asset('/storage/public/kategoriobats/'.$p->image) }}" alt="product-item" class="product-image img-fluid">
                        ...
                        <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                            <h3 class="card-title fs-6 fw-normal m-0">
                                <a href="index.html">{{ $p->name }}</a>
                            </h3>
                            <span class="card-price fw-bold">ini harga</span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="modal-body">
                                <div class="col-lg-12 col-md-12 me-3">
                                    <div class="image-holder">
                                        <img src="{{ asset('/storage/public/kategoriobats/'.$p->image) }}" alt="Shoes" class="product-image img-fluid">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12">
                                    <div class="summary">
                                        <div class="summary-content fs-6">
                                            ...
                                            <button type="submit" class="btn btn-medium btn-black hvr-sweep-to-right">Pesan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
  ...
  <section id="latest-products" class="product-store py-2 my-2 py-md-5 my-md-5 pt-0">
      ...
      <div class="product-content padding-small">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
            ...
            <div class="col mb-4 mb-3">
                <div class="product-card position-relative">
                  <div class="card-img">
                    <img src="{{ asset('/storage/public/kategoriproduks/'.$alkes->image) }}" alt="product-item" class="product-image img-fluid">
                    <div class="cart-concern position-absolute d-flex justify-content-center">
                      <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-center mt-3">
                    <h3 class="card-title fs-6 fw-normal m-0">
                      <a href="index.html">{{ $alkes->name }}</a>
                    </h3>
    ...
    <script>
      ...
      {
          $(document).on('click','#detail_kategori_obat_percobaan', function() {
              var id =$(this).data('id');
