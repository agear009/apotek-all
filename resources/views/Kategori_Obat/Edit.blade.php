                ...
                <div class="card card-round">
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      ...
                      <!-- Projects table -->
                      <form action="{{ route('kategori_obat.update', $kategori->id) }}" method="POST"  enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        ...
                        <tbody>
                          <tr>
                            <th scope="row" colspan="6">
                                <label for="exampleInputname1" class="form-label">Nama Kategori</label>
                          ...
                          <tr>
                            ...
                            <img src="{{ asset('storage/public/kategoriobats/'.$kategori->image) }}" width="20%">
