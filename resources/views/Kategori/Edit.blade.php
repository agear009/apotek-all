                  ...
                  <div class="card-body p-0">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <img src="{{ asset('/storage/public/kategoriproduks/'.$kategori->image) }}" width="20%"><br><br>
                    ...
                    <script>
                        ...
                        window.onload = function() {
                            ...
                            if (kategori.image) {
                                imagePreview.innerHTML = `<img src="storage/kategoriproduks/${kategori.image}" width="20%"><br>`;
                            }
                        }
