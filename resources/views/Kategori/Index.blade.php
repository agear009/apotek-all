          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Silahkan tambah Kategori Produk</h6>
              </div>
                  ...
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">
                        ...
                        <form class="navbar-left navbar-form nav-search" action="{{ route('kategori.index') }}" role="search" method="get">
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <th scope="col" width="20%"><img src="{{ asset('/storage/public/kategoriproduks/'.$kategori->image) }}" width="20%"></th>
