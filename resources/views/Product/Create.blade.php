                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" aria-describedby="Cover" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="price"value="{{ old('Harga') }}" aria-describedby=" author name" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="merek"value="{{ old('Merek') }}" aria-describedby=" author name" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="jumlah_penjualan" value="{{ old('jumlah_penjualan') }}"  aria-describedby="source" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="jumlah_maksimal_beli" value="{{ old('jumlah_maksimal_beli') }}"  aria-describedby="source"  required>
                          ...
                          <tr>
                              <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="producer" name="harga_coret" value="{{ old('harga_coret') }}"  aria-describedby="source" required>
                              ...
                              <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="producer" name="produksi" value="{{ old('produksi') }}"  aria-describedby="source" required>
                              ...
                              <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="producer" name="produsen" value="{{ old('produsen') }}"  aria-describedby="source" required>
