                  ...
                  <div class="card-body p-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="jumlah" value="{{ old('jumlah') }}"  aria-describedby="source" required>
                    ...
                    <script>
                        ...
                        window.onload = function() {
                            ...
                            if (gudang.image) {
                                imagePreview.innerHTML = `<img src="storage/gudangs/${gudang.image}" width="20%"><br>`;
                            }
                        }
                        ...
                        function validateForm() {
                            const fileInput = document.getElementById('imageUpload');
                            if (!fileInput.files[0] && !gudang.image) {
