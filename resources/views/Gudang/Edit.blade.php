                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="category" name="category" aria-describedby="category" required >
                                    <option name="category" value="{{ $gudang->category }}">{{ $gudang->category }}</option>
                          ...
                          <tr>
                            ...
                            <img src="{{ asset('/storage/public/gudangs/'.$gudang->image) }}" width="20%">
                            <input type="file" class="form-control" id="name" name="image" aria-describedby="Cover" value="{{ $gudang->image }}">
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" aria-describedby="name Category" value="{{ $gudang->name }}" required>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <textarea id="myTextarea" name="deskripsi">{{ $gudang->deskripsi }}</textarea>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <select class="form-control" id="id_category" name="status" aria-describedby="category" required >
                                    <option name="status" value="{{ $gudang->status }}">{{ $gudang->status }}</option>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="producer" name="jumlah" aria-describedby="source" value="{{ $gudang->jumlah }}" required >
